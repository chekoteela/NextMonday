...
public class DayAndMonth {
    ...
    public static final String MARCH = "Мар";
    public static final String APRIL = "Апр";
    public static final String MAY = "Май";
    public static final String JUNE = "Июн";
    public static final String JULY = "Июл";
    public static final String AUGUST = "Авг";
    public static final String SEPTEMBER = "Сен";
    public static final String NOVEMBER = "Ноя";
    public static final String OCTOBER = "Окт";
    public static final String DECEMBER = "Дек";
