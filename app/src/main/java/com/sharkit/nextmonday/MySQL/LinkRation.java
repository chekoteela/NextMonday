...
public class LinkRation extends SQLiteOpenHelper {
    ...
    public LinkRation(Context context){
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TABLE + "( "+COLUMN_ID+" TEXT," + COLUMN_DATE+" TEXT , "+ COLUMN_CODE+" TEXT , "+COLUMN_MEAL+" TEXT," +
                COLUMN_NUMBER +" TEXT, " +COLUMN_NAME+" TEXT , "+COLUMN_PORTION+" TEXT," +
                ...
                COLUMN_POTASSIUM +" TEXT, " + COLUMN_DATE_MILLIS + " INTEGER UNIQUE)");
    }
